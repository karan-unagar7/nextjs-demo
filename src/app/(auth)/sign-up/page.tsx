...
//     // it' for debouncing value(username state ma value add krse) after perticular time
...
//     useEffect(() => {
//         const checkUsernaemUnique = async () => {
//             if (username) {
...
//                                         <p
//                                             className={`text-sm ${usernameMsg === 'Username are Unique'
//                                                 ? 'text-green-500'
//                                                 : 'text-red-500'
//                                                 }`}
//                                         >
